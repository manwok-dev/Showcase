...
//Bruch bruch1 = new Bruch(77, 22);
//Bruch bruch2 = new Bruch(10, 77);

//Bruch ergBruch = bruch1.Mult(bruch2);

//Console.WriteLine(ergBruch.GetAusgabeString());

//Console.WriteLine(bruch1 + " Dezimal :" + bruch1.GetDezimal());

//Bruch subtrBruch = bruch1.Subtr(bruch2);
//Console.WriteLine(subtrBruch.GetAusgabeString());
//subtrBruch.Kuerzen();
//Console.WriteLine(subtrBruch.GetAusgabeString());

//Bruch addBruch = bruch1.Add(bruch2);
//Console.WriteLine(addBruch.GetAusgabeString());
//addBruch.Kuerzen();
//Console.WriteLine(addBruch.GetAusgabeString());

//Bruch divBruch = bruch1.Div(bruch2);
//Console.WriteLine(divBruch.GetAusgabeString());
//divBruch.Kuerzen();
//Console.WriteLine(divBruch.GetAusgabeString());